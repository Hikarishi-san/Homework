...
func main() {
 ...
 for {
  ...
  // В тестах ожидается округлённый результат в мегабайтах (MiB).
  // Поэтому переводим в MiB и округляем до ближайшего целого.
  netAvailableMbit := (netAvailable + (1024*1024)/2) / (1024 * 1024)
